//=================================================================
//        MyJSQLView DataImportPreferencesPanel
//=================================================================
//
// 	This class provides a generic panel used in the Preferences
// Menu to highlight the Data Import options.
//
//          << DataImportPreferencesPanel.java >>
//
//=================================================================
...
//=================================================================
// Version 1.0 12/03/2007 Initial DataImportPreferencesPanel Class.
//         1.1 12/12/2008 Header Update.
//         1.2 05/13/2008 Added Class Instance serialVersionUID.
//                        Declared backgroundImage transient.
//         1.3 10/21/2008 MyJSQLView Project Common Source Code
//                        Formatting.
//         1.4 05/27/2009 Header Format Changes/Update.
//         1.5 10/24/2009 Constructor Instance fileSeparator Obtained
...
/**
 * The DataImportPreferencesPanel class provides a generic panel
 * used in the Preferences Menu to highlight the Data Import options.
 * 
 * @author Dana M. Proctor
 * @version 1.6 02/18/2010
 */

class DataImportPreferencesPanel extends JPanel
{
   // Class Instances.
   private static final long serialVersionUID = 1492564135723186932L;
   ...
   //===========================================================
   // DataImportPreferencesPanel Constructor
   //===========================================================

   protected DataImportPreferencesPanel()
   {
      ...
      // instances values.
      backgroundImage = new ImageIcon("images" + fileSeparator + "DataImportPreferencesPanel.jpg").getImage();
