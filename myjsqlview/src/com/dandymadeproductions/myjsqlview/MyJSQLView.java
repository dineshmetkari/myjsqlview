...
//         3.38 08/06/2012 Change in MyJSQLView_ResourceBundle Class Requirements Arguments
//                         for Constructor & setLocaleResource(). Changed Class Method
//                         getLocaleResourceBundle() to getResourceBundle().
//         3.39 09/11/2012 Organized Imports to Clarify New Package Naming. Updated
//                         myJSQLView_Version.
...
//                         7.02.
//         7.03 06/04/2015 Class Instance myJSLView_Version Update for Release
//                         7.03.
//                              
//-----------------------------------------------------------------
...
public class MyJSQLView implements ActionListener
{
   ...
   private static String[] myJSQLView_Version = {"MyJSQLView", "7.03", "Build ID: 20150604"};
   private String webSiteString = "http://myjsqlview.com";
