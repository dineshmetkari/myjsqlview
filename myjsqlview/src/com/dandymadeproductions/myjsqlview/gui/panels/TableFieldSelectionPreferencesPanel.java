...
//         4.9 Changed Package Name to com.dandymadeproductions.myjsqlview.gui.panels.
//             Made Class, Constructor, & updatePreferences() Public.
//             
//-----------------------------------------------------------------
...
public class TableFieldSelectionPreferencesPanel extends JPanel implements ActionListener, ItemListener
{
   ...
   public TableFieldSelectionPreferencesPanel(TableTabPanel tableTabPanel, MyJSQLView_ResourceBundle resourceBundle)
   {
