...
//             default).
//         3.7 Changed Package Name to com.dandymadeproductions.myjsqlview.gui.panels.
...
public class TableRowSelectionPreferencesPanel extends JPanel implements ActionListener, ChangeListener
{
   ...
   public TableRowSelectionPreferencesPanel(String tableName, MyJSQLView_ResourceBundle resourceBundle)
   {
