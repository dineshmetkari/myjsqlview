//=================================================================
//                    MyJSQLView GzFileFilter
//=================================================================
//
//    This class provides a custom FileFilter instance to be used
// in selecting MyJSQLView plugin repository files, gz.
//
//                  << GzFileFilter.java >>
//
//=================================================================
...
//=================================================================
// Version 1.0 Original MyJSQLView GzFileFilter Class.
//             
//-----------------------------------------------------------------
 ...
 * be used in selecting MyJSQLView plugin repository files, GZ.
 * 
...
public class GzFileFilter extends FileFilter
{
   ...
   public boolean accept(File file)
   {
      ...
      // Only MyJSQLView Plugin Module Files, *.gz
      extension = "";
