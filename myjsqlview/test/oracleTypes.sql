...
--                    for finalializing during MyJSQLView Oracle
--                    data types support.
...
-- if it is not used if using MyJSQLView for the import. Oracle
...
-- the statement after commenting, MyJSQLView will then not treat
