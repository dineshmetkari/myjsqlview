...
DROP TABLE IF EXISTS timeStamp0_types;
...
--  Table id and creation data entries.
    data_type_id IDENTITY NOT NULL PRIMARY KEY,
...
CREATE TABLE timeStamp0_types (

--  Table id and creation data entries.
    data_type_id IDENTITY PRIMARY KEY,
    timeStamp0_type TIMESTAMP(0) DEFAULT NULL
)
...
--  Table id and creation data entries.
    data_type_id IDENTITY PRIMARY KEY,
    timeStamp_type TIMESTAMP(6) DEFAULT NULL
)
...
INSERT INTO timeStamp0_types (timeStamp0_type)
	VALUES ('1970-01-01 00:00:00');
INSERT INTO timeStamp0_types (timeStamp0_type)
    VALUES ('2005-01-11 09:43:01');

INSERT INTO timeStamp_types (timeStamp_type)
	VALUES ('1970-01-01 00:00:00.000000000');
INSERT INTO timeStamp_types (timeStamp_type)
    VALUES ('2005-01-11 09:43:01.000000000');