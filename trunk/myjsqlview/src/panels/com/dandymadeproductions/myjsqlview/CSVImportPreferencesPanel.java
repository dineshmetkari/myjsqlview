...
class CSVImportPreferencesPanel extends JPanel implements ActionListener, KeyListener
{
   ...
   protected CSVImportPreferencesFiller csvImportPanelFiller;
   ...
   protected CSVImportPreferencesPanel(MyJSQLView_ResourceBundle resourceBundle)
   {
      // Class Instances
   ...
   protected DataImportProperties getCSVImportOptions()
   {
   ...
   protected void setCSVImportProperties(DataImportProperties dataProperties)
   {
      // Delimiter
