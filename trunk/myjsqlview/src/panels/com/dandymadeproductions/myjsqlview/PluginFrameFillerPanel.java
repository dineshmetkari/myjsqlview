//=================================================================
//            MyJSQLView PluginFrameFillerPanel
//=================================================================
//
...
//=================================================================
// Version 1.0 08/29/2012 Original PluginFrameFillerPanel Class.
//                      
//-----------------------------------------------------------------
...
class PluginFrameFillerPanel extends JPanel implements Runnable
{
   // Class Instances.
   private static final long serialVersionUID = -5392681056972223821L;
   ...
   private BasicStroke widePen, narrowPen;
   ...
   protected PluginFrameFillerPanel()
   {
      // Class Instances
      Thread t;
   ...
   private void drawAnimation(Graphics g)
   {
      ...
      panelWidth = (double) getWidth();
      panelHeight = (double) getHeight();
      orgAffineTransform = g2d.getTransform();
      
      // Do a fill.
      
      g2d.setPaint(waveBackgroundColor);
      backDrop = new Rectangle2D.Double(0, 0, panelWidth, panelHeight);
      g2d.fill(backDrop);
      ...
      g2d.draw(new Line2D.Double(0, 0, panelWidth, 0));
      g2d.draw(new Line2D.Double(0, 0, 0, panelHeight));

      g2d.setStroke(narrowPen);
      g2d.setPaint(Color.white);
      g2d.draw(new Line2D.Double(panelWidth, 3.0, panelWidth, panelHeight));
      g2d.draw(new Line2D.Double(3.0, panelHeight, panelWidth, panelHeight));
