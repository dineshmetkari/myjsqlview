//=================================================================
//         MyJSQLView DataExportPreferencesPanel
//=================================================================
//
// 	This class provides a generic panel used in the Preferences
// Menu to highlight the Data Export options.
//
//          << DataExportPreferencesPanel.java >>
//
//=================================================================
...
//=================================================================
// Version 1.0 04/26/2007 Original DataPanel Outline Class.
//         1.1 04/28/2007 Renamed to DataPreferencesPanel.
//         1.2 06/18/2007 Added Graphics Background Image.
//         1.3 09/19/2007 Used System.getProperty("file.separator") for All File
//                        System Resources Accesses Through Instance fileSeparator.
//         1.4 12/03/2007 Renamed to DataExportPreferencesPanel.Changed Image
//                        File to Same.
//         1.5 12/12/2007 Header Update.
//         1.6 05/13/2008 Added Class Instance serialVersionUID. Declared
//                        backgroundImage transient.
//         1.7 10/21/2008 MyJSQLView Project Common Source Code Formatting.
//         1.8 05/27/2009 Header Format Changes/Update.
//         1.9 10/24/2009 Constructor Instance fileSeparator Obtained From
...
/**
 * The DataExportPreferencesPanel class provides a generic panel used
 * in the Preferences Menu to highlight the Data Export options.
 * 
 * @author Dana M. Proctor
 * @version 2.0 02/18/2010
 */

class DataExportPreferencesPanel extends JPanel
{
   // Class Instances.
   private static final long serialVersionUID = -8292828214453148930L;
   ...
   //==============================================================
   // DataExportPreferencesPanel Constructor
   //==============================================================

   protected DataExportPreferencesPanel()
   {
      ...
      // instances values.
      backgroundImage = new ImageIcon("images" + fileSeparator + "DataExportPreferencesPanel.jpg").getImage();
