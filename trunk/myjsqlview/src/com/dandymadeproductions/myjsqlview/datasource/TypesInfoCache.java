...
public class TypesInfoCache
{
   ...
   private static final int[][] H2_TYPES = {
       ...
       {TypeID.H2_CHAR, TypeID.H2_CHAR, TypeID.HSQL_CHARACTER, TypeID.DERBY_CHAR},
   ...
   private static final int[][] HSQL_TYPES = {
       ...
       {TypeID.HSQL_CHARACTER, TypeID.H2_CHAR, TypeID.HSQL_CHARACTER, TypeID.DERBY_CHAR},
   ...
   private static final int[][] DERBY_TYPES = {
       {TypeID.DERBY_IDENTITY, TypeID.H2_IDENTITY, TypeID.HSQL_IDENTITY, TypeID.DERBY_BIGINT},
       {TypeID.DERBY_CHAR, TypeID.H2_CHAR, TypeID.HSQL_CHARACTER, TypeID.DERBY_CHAR},
   ...
   private static final int[][] POSTGRESQL_TYPES = {
       ...
       {TypeID.POSTGRESQL_CHAR, TypeID.H2_CHAR, TypeID.HSQL_CHARACTER, TypeID.DERBY_CHAR},
       {TypeID.POSTGRESQL_BPCHAR, TypeID.H2_CHAR, TypeID.HSQL_CHARACTER, TypeID.DERBY_CHAR},
   ...
   private static final int[][] MYSQL_TYPES = {
       {TypeID.MYSQL_CHAR, TypeID.H2_CHAR, TypeID.HSQL_CHARACTER, TypeID.DERBY_CHAR},
   ...
   private static final int[][] ORACLE_TYPES = {
       ...
       {TypeID.ORACLE_FLOAT, TypeID.H2_REAL, TypeID.HSQL_FLOAT, TypeID.DERBY_REAL},
       {TypeID.ORACLE_BINARY_FLOAT, TypeID.H2_REAL, TypeID.HSQL_FLOAT, TypeID.DERBY_REAL},
       {TypeID.ORACLE_BINARY_DOUBLE, TypeID.H2_DOUBLE, TypeID.HSQL_DOUBLE, TypeID.DERBY_DOUBLE},
       {TypeID.ORACEL_DOUBLE, TypeID.H2_DOUBLE, TypeID.HSQL_DOUBLE, TypeID.DERBY_DOUBLE},
   ...
   private static final int[][] MSACCESS_TYPES = {
       {TypeID.MSACCESS_COUNTER, TypeID.H2_IDENTITY, TypeID.HSQL_IDENTITY, TypeID.DERBY_BIGINT},
