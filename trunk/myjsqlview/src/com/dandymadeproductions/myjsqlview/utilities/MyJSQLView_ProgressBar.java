...
//         3.1 Changed Package Name to com.dandymadeproductions.myjsqlview.utilities.
//             Made Class, Constructor, Setter Methods, isCanceled(), & center()
//             Public.
//
//-----------------------------------------------------------------
...
public class MyJSQLView_ProgressBar extends JFrame implements ActionListener
{
   // Class Instances
   ...
   public MyJSQLView_ProgressBar(String progressTitle)
   {
      super(progressTitle);
