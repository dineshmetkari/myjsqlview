...
//         4.8 Changed Package Name to com.dandymadeproductions.myjsqlview.gui.panels.
//             Made Class, Constructor, & All Methods Public.
//             
//-----------------------------------------------------------------
...
import com.dandymadeproductions.myjsqlview.gui.LoginManagerFrame;
...
public class SitesTreePanel extends JPanel implements TreeModelListener, TreeSelectionListener
{
   // Class Instances.
   ...
   public SitesTreePanel(LoginManagerFrame parent,
   ...
   public DefaultMutableTreeNode addSite(DefaultMutableTreeNode parent, Object child,
