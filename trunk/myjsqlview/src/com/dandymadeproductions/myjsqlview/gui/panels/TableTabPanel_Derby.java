...
// MyJSQLView is listed according to a specified sort and search.
// Entries from the database table may be viewed, added, edited,
// or deleted by means of this panel. The panel also provides
...
/**
 *    The TableTabPanel_Derby class provides the means to create a default table
 * summary view of data in an Apache Derby database that in MyJSQLView is listed
      ...
      try
      {
         ...
         for (int i = 1; i < tableMetaData.getColumnCount() + 1; i++)
         {
            ...
            if (((columnType.toUpperCase().equals("BLOB"))
                  || (columnType.toUpperCase().equals("CLOB"))
