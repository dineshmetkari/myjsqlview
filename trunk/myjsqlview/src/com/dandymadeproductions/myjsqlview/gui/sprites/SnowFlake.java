//=================================================================
//                  MyJSQLView SnowFlake
//=================================================================
//
//    This class provides the characteristics of a snow flake
...
//=================================================================
// Version 1.0 Initial SnowFlake Class.
//         1.1 Modified the Behavior of the Snow Flakes in
//             the Class Method updatePosition().
//         1.2 Header Update.
...
//         2.0 Changed Package Name to com.dandymadeproductions.myjsqlview.gui.sprites.
...
public class SnowFlake extends Sprite
{
   ...
   public SnowFlake(Component component, Rectangle panelBounds, Image image,
   ...
   //==============================================================
   // Class method to allow the updating of this snowflake's location
   ...
   public void updatePosition()
   {
      ...
      // Move the snowflake on the screen
      position.translate(nextPosition.x, nextPosition.y);

      // ==========================================
      // Manage snowflakes that exceed the boundary
