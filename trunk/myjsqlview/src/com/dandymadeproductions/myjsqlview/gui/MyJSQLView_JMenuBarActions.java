...
import com.dandymadeproductions.myjsqlview.gui.panels.AppGeneralPreferencesPanel;
...
class MyJSQLView_JMenuBarActions extends MyJSQLView implements MyJSQLView_MenuActionCommands, ActionListener
{
   ...
   private static void generalPropertiesAction(MyJSQLView_Frame parent)
   {
      // Method Instances.
      ...
      if (generalPreferencesDialog.isActionResult())
      {
         ...
         if (!appGeneralPreferencesPanel.getLocalization().equals(MyJSQLView.getLocaleString()))
         {
            try
            {
