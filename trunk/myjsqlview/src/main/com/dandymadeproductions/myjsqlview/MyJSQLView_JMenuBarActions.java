...
class MyJSQLView_JMenuBarActions extends MyJSQLView implements ActionListener
{
         ...
         if (!fileName.equals(""))
         {
            ...
            if (actionCommand.equals("DISQLD"))
            {
               ...
               if (importWarningDialog.isActionResult())
               {
                  ...
                  if (reloadDBTables.isSelected())
                     new SQLDataDumpImportThread(fileName, true);
                  else
                     new SQLDataDumpImportThread(fileName, false); 
               }
            ...
            else if (actionCommand.equals("DICSVF"))
            {
               ...
               if (insertUpdateDialog.isActionResult())
               {
                  ...
                  new CSVDataImportThread(fileName, csvOption, false);
               }
                                        ...
                                        String[] myJSQLView_Version)
   {
      ...
      HashMap tableColumnNamesHashMap, tableColumnClassHashMap;
      HashMap tableColumnTypeHashMap, tableColumnSizeHashMap;
      JTable summaryListTable;

      // Initializing
      tableColumnNamesHashMap = new HashMap();
      tableColumnClassHashMap = new HashMap();
      tableColumnTypeHashMap = new HashMap();
      tableColumnSizeHashMap = new HashMap();
         ...
         if (!fileName.equals(""))
         {
            ...
            if (actionCommand.equals("DECSVT"))
            {
               ...
               new DataDumpThread(tableHeadings, tableColumnNamesHashMap,
                                  tableColumnClassHashMap, tableColumnTypeHashMap,
                                  tableColumnSizeHashMap, exportedTable, fileName);
            }
            ...
            else if (actionCommand.equals("DESQLT"))
            {
               new SQLDataDumpThread(tableHeadings, tableColumnNamesHashMap, false,
                                     tableColumnClassHashMap, tableColumnTypeHashMap,
                                     exportedTable, fileName, myJSQLView_Version);
            }
